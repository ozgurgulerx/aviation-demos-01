...
SQL_DIALECT="${SQL_DIALECT:-postgres}"
RETRIEVAL_STRICT_SOURCE_MODE="${RETRIEVAL_STRICT_SOURCE_MODE:-false}"
ALLOW_SQLITE_FALLBACK="${ALLOW_SQLITE_FALLBACK:-true}"
ALLOW_MOCK_KQL_FALLBACK="${ALLOW_MOCK_KQL_FALLBACK:-true}"
ALLOW_MOCK_GRAPH_FALLBACK="${ALLOW_MOCK_GRAPH_FALLBACK:-true}"
ALLOW_MOCK_NOSQL_FALLBACK="${ALLOW_MOCK_NOSQL_FALLBACK:-true}"
...
if bool_true "$DEPLOY_K8S"; then
  ...
  export USE_POSTGRES
  export SQL_DIALECT
  export RETRIEVAL_STRICT_SOURCE_MODE
  export ALLOW_SQLITE_FALLBACK
  export ALLOW_MOCK_KQL_FALLBACK
  export ALLOW_MOCK_GRAPH_FALLBACK
  export ALLOW_MOCK_NOSQL_FALLBACK
